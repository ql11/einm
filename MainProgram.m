...
fid=fopen('程序记录yyyy-mm-dd.txt','w');
...
fid_6 = fopen('全部电子落点【正负2.50m】.txt','w');
fid_7 = fopen('计算的电子个数.txt','w');
...
disp('程序开始，读取磁场数据中……');
tic
%load('/public1/home/sc40009/QinLang/From office/20190107/0110_V.mat');
...
parfor k = 0:(Total - 1)
    ...
    fid=fopen('程序记录yyyy-mm-dd.txt','a');
    ...
    fid_6 = fopen('全部电子落点【正负2.50m】.txt','a');
